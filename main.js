	...
	for (let i = 0, len = floor.length; i < len; i++) {
      ...
      var imagee = new Image();
		...
		if(targ.texture=='wire.png'){
			...
			if(floor[i+1].texture=='wireAlt.png' && floor[(i+1)-20].texture=='wireAlt.png'){
					floor[i+1].texture='wireTurnUp.png'
			}
			if(floor[i+1].texture=='wireTurnUp.png' && floor[(i+1)-20].texture=='wireAlt.png'){
			...
			if(floor[i+1].texture=='wireTurnDown.png' && floor[(i+1)+20].texture=='wireAlt.png'){
				if(targ.overlayTexture=='electric.png'){
					floor[(i+1)+20].overlayTexture='electricAlt.png'
			...
			if(floor[i-1].texture=='wireTurnUp1.png' && floor[(i-1)-20].texture=='wireAlt.png'){
				if(targ.overlayTexture=='electric.png'){
					floor[(i-1)-20].overlayTexture='electricAlt.png'
			...
			if(floor[i-1].texture=='wireTurnDown1.png' && floor[(i-1)+20].texture=='wireAlt.png'){
				if(targ.overlayTexture=='electric.png'){
					floor[(i-1)+20].overlayTexture='electricAlt.png'
		...
		if(targ.texture=='wireAlt.png'){// \/
			...
			if(floor[i-20].texture=='wire.png' && floor[(i-20)+1].texture=='wire.png'){
					floor[i-20].texture='wireTurnDown1.png'
			}
			if(floor[i-20].texture=='wireTurnDown1.png' && floor[(i-20)+1].texture=='wire.png'){
			...
			if(floor[i-20].texture=='wireTurnDown.png' && floor[(i-20)-1].texture=='wire.png'){
				if(targ.overlayTexture=='electricAlt.png'){
					floor[(i-20)-1].overlayTexture='electric.png'
			...
			if(floor[i+20].texture=='wireTurnUp1.png' && floor[(i+20)+1].texture=='wire.png'){
				if(targ.overlayTexture=='electricAlt.png'){
					floor[(i+20)+1].overlayTexture='electric.png'
			...
			if(floor[i+20].texture=='wireTurnUp.png' && floor[(i+20)-1].texture=='wire.png'){
				if(targ.overlayTexture=='electricAlt.png'){
					floor[(i+20)-1].overlayTexture='electric.png'
